...
Gitseer has not made a stable release. Security fixes are applied to the current `main` branch only; older commits and development snapshots are not supported release lines.

## Reporting a vulnerability

Use [GitHub private vulnerability reporting](https://github.com/griwes/gitseer/security/advisories/new) when it is available. Do not disclose a suspected vulnerability in a public issue, discussion, or pull request.
